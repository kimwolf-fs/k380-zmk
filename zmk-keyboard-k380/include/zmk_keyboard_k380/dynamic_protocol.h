...
#define K380_DYNAMIC_PROTOCOL_VERSION 2
#define K380_DYNAMIC_CONFIG_VERSION 2
#define K380_DYNAMIC_MAX_PAYLOAD 512
#define K380_DYNAMIC_MACRO_CHUNK_MAX 384
...
enum k380_dynamic_command {
    ...
    K380_DYNAMIC_COMMAND_TEST_MACRO = 10,
    K380_DYNAMIC_COMMAND_GET_MACRO_META = 11,
    K380_DYNAMIC_COMMAND_READ_MACRO_CHUNK = 12,
    K380_DYNAMIC_COMMAND_BEGIN_MACRO_UPLOAD = 13,
    K380_DYNAMIC_COMMAND_WRITE_MACRO_CHUNK = 14,
    K380_DYNAMIC_COMMAND_COMMIT_MACRO_UPLOAD = 15,
    K380_DYNAMIC_COMMAND_ABORT_MACRO_UPLOAD = 16,
    K380_DYNAMIC_COMMAND_GET_MACRO_RUN_STATE = 17,
    K380_DYNAMIC_COMMAND_STOP_MACRO = 18,
};
...
enum k380_dynamic_result {
    ...
    K380_DYNAMIC_RESULT_UPLOAD_OFFSET_MISMATCH,
    K380_DYNAMIC_RESULT_TRACE_CURSOR_LOST,
    K380_DYNAMIC_RESULT_STALE_RUN,
};
